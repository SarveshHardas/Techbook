      ...
      <View style={styles.container}>
        ...
        <View style={{ flexDirection: 'row', flex: 1 }}>
          <TouchableOpacity
            ...
            />
            <Text style={styles.buttonText}>Mathematics Notes</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            />
            <Text style={styles.buttonText}>Physics Notes</Text>
          </TouchableOpacity>
          </View>
          ...
          <View style={{ flexDirection: 'row', flex: 1 }}>
            <TouchableOpacity
              ...
              />
              <Text style={styles.buttonText}>Chemistry Notes</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              />
              <Text style={styles.buttonText}>Biology Notes</Text>
            </TouchableOpacity>
          </View>
      </View>
    );
